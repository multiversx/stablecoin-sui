...
module treasury::treasury {
    ...
    use treasury::mint_allowance::{Self, MintAllowance};
    use treasury::roles::{Self, Roles};
    use treasury::version_control::{Self, assert_object_version_is_compatible_with_package};
