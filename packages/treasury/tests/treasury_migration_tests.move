...
#[test_only]
module treasury::treasury_migration_tests {
    use sui::{
        coin,
        event,
        vec_set,
    ...
    #[test, expected_failure(abort_code = ::treasury::two_step_role::ESenderNotActiveRole)]
    ...
    #[test, expected_failure(abort_code = ::treasury::treasury::EMigrationStarted)]
    ...
    #[test, expected_failure(abort_code = ::treasury::treasury::EMigrationNotStarted)]
    ...
    #[test, expected_failure(abort_code = ::treasury::treasury::ENotPendingVersion)]
