...
public fun accept_role<T>(role: &mut TwoStepRole<T>, ctx: &TxContext) {
...
#[test_only]
public fun create_role_transfer_started_event<T>(
    old_address: address,
    new_address: address,
...
#[test_only]
public fun create_role_transferred_event<T>(
    old_address: address,
    new_address: address,
): RoleTransferred<T> {
